...
<head>
    ...
    <style type="text/css" rel="stylesheet">
        body{background-color: black; color: white; font-size: 18px; font-family: "Consolas"; margin: 20px;}
        h1{text-align: center;}
        a{color: orange; font-size: 18px; cursor: pointer; text-decoration: none;}
        div{float: right;}
    </style>
</head>
<body>
<h1>Oauth2 Server 端流程</h1>
<h3 align="center">fork来源：
    <a target="_blank" href="https://github.com/ameizi/oltu-oauth2-example">
...
client_id和client_secret 这两个以后会用到

client_id               c1ebe466-1cdc-4bd3-ab69-77c3561b9dee    应用id
client_secret           d8346ea2-6017-43ed-ad68-19c0f971738b    应用secret

2. 请求授权码
<a target="_blank" href="http://localhost:8080/authorize?client_id=c1ebe466-1cdc-4bd3-ab69-77c3561b9dee&response_type=code&redirect_uri=http://aimeizi.net">
...
http://aimeizi.net/?<font color="red">code=63910432da9186b22b1ad888d55ae8ae</font>
...
首先GET方式请求
<a target="_blank" href="http://localhost:8080/access">
...
4. 测试accessToken
<a target="_blank" href="http://localhost:8080/v1/openapi/userInfo?access_token=223ae05dfbb0794396fb60a0960c197e">
